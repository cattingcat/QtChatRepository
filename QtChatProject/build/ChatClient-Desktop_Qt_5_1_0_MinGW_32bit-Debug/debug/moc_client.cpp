...
QT_MOC_LITERAL(5, 44, 7)
    ...
    "Client\0messageReceive\0\0dataRead\0"
    "sendMessage\0message\0"
};
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->messageReceive((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->dataRead(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Client::messageReceive)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Client::messageReceive(const QString & _t1)
{
