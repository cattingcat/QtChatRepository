...
#include "../../../ChatClient/authwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AuthWindow_t, stringdata) + ofs \
...
const QMetaObject AuthWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AuthWindow.data,
      qt_meta_data_AuthWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AuthWindow.stringdata))
        return static_cast<void*>(const_cast< AuthWindow*>(this));
